...
public final class MyService extends AbstractService {
  ...
  * 6. При создании юзера кошелеки могут отсутствовать
  * 7. При вызове функций get научить выдавать принадлежащую хозяину информацию (необходимо проверять подпись с солью/нонсом)
  *
  * Хранить информацию:
  * Кошелек{
  *      ид(адрес)
  *      баланс
  *     хозяин(публичный ключ)
  * }
  *
  * Юзер{
  *     address(его публичный ключ)
  *     машины[...]
  *     имя
  *     кошельки[ Кошелек#ид(адрес)... ]
  *
  *  }
  *
  *  */
